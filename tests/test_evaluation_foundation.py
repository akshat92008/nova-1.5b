...
def write_evaluation(directory, model_id, success, case_hash="cases", tasks=100):
    directory.mkdir()
    ...
    metrics = {
        ...
        "valid_protocol_rate": 0.95,
        "patch_application_rate": 0.92,
    ...
    output = json.dumps(
        {
            ...
            "files": [
                {"path": "value.py", "action": "update", "content": "VALUE = 2\n"}
            ],
        }
    )
